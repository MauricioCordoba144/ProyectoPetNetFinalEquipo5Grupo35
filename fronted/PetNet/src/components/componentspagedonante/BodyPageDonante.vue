<template>
    <div id="main_donante">
            ...
            <div id="imagen_main_donante">
                <!-- <img src="mascota_hombro.jpg" class="center" width="610" height="660"alt=""> -->
                <img src="../../../public/mascota_hombro.jpg" class="center" width="610" height="600" alt="">
            </div>
            <div id="botones">
                <div id="boton1">
...
#main_donante{
        ...
        #parrafomain1_donante{
            font-size:x-large;
            margin: 1em;
            color: rgb(12, 12, 163);
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
        }
        #parrafomain2_donante{
            font-size:xx-large;
            margin: 1em;
            color: rgb(12, 12, 163);
            font-weight:bold;
        ...
        .boton{
            width: 150px;
            height: 50px;
            background-color: rgb(54, 35, 161);
            border-radius: 0.5em;
            cursor: pointer;
